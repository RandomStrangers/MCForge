...
namespace MCForge
{
    public class Block
    {
        ...
        public const ushort door_deepblue = (ushort)223;
        ...
        public const ushort door_deepblue_air = (ushort)228;
        ...
        public static string Name(ushort type)
        {
            switch (type)
            {
                ...
                case door_deepblue: return "door_deepblue";
                ...
                case door_deepblue_air: return "door_deepblue_air";
        ...
        public static ushort Convert(ushort b)
        {
            switch (b)
            {
                ...
                case door_deepblue: return deepblue;
        ...
        public static ushort SaveConvert(ushort b)
        {
            switch (b)
            {
                ...
                case door_deepblue_air: return door_deepblue;
        ...
        public static ushort DoorAirs(ushort b)
        {
            switch (b)
            {
                ...
                case door_deepblue: return door_deepblue_air;
