...
namespace MCForge.Gui {
    public partial class PropertyWindow : Form {
        ...
        private void saveAll() {
            ...
            Server.forgeProtection = comboBoxProtection.SelectedItem.ToString() == "Dev" ? ForgeProtection.Dev : comboBoxProtection.SelectedItem.ToString() == "Mod" ? ForgeProtection.Mod : comboBoxProtection.SelectedItem.ToString() == "oldDev" ? ForgeProtection.oldDev : ForgeProtection.Off;
            ...
            Server.Owner = txtServerOwner.Text;
      ...
      /*      Server.useMySQL = chkUseSQL.Checked;
            ...
            */
            ...
            Server.Server_ALT = "MCForge Testing Server";
            Server.Server_Disc = "TEST";
            Server.Server_Flag = "FREEBUILD";
